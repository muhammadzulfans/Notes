          ...
          <div className="bg-orange-300 h-screen">
               <div className="text-4xl p-16 font-mono">
                    <div className="flex justify-between grid-rows-2 px-16">
                         <button>
                              <img src="/src/assets/left-arrow.png" className="w-20" />
                         </button>
                         <button>
                              <img src="/src/assets/check.png" className="w-24" />
                         </button>
                    </div>
                    <form>
                         <div className="px-20 pt-12">
                              <input type="text" className="text-7xl bg-transparent border-b-2 border-orange-700 w-full py-2 px-3 text-black placeholder-gray-500 focus:outline-none" placeholder="Judul" />
                         </div>
